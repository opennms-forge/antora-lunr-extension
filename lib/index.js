...
function assetFile (uiCatalog, logger, uiOutputDir, assetDir, basename, assetPath = ospath.join(assetDir, basename), createContents = () => new LazyReadable(() => fs.createReadStream(ospath.join(__dirname, '../data', assetPath))), overwrite = false) {
